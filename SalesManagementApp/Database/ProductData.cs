...
namespace SalesManagementApp.Database
{
    public static class ProductData
    {
        ...
        private static ProductList Init()
        {
            ...
            list_.AddLast(new Product("PRO001", "Banh Quy", 31, new Date(10, 10, 2022,10,10,10), new Date(1, 1, 2023,10,10,20),120000));
            list_.AddLast(new Product("PRO002", "Banh Chuoi", 90, new Date(9, 9, 2022,20,21,43), new Date(2, 2, 2023,7,12,29),150000));
            ...
            list_.AddLast(new Product("PRO008", "Tra Sua", 99, new Date(3, 3, 2022,11,11,11), new Date(9, 9, 2027,3,4,5),12000));
            list_.AddLast(new Product("PRO009", "Nuoc Ngot", 92, new Date(2, 2, 2025,11,12,20), new Date(5, 3, 2030,21,22,22),20000));
            return list_;
        }
    }
}
